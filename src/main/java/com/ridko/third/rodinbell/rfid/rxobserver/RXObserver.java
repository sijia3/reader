package com.ridko.third.rodinbell.rfid.rxobserver;

import com.ridko.third.rodinbell.rfid.bean.MessageTran;
import com.ridko.third.rodinbell.rfid.config.CMD;
import com.ridko.third.rodinbell.rfid.config.ERROR;
import com.ridko.third.rodinbell.rfid.config.HEAD;
import com.ridko.third.rodinbell.rfid.rxobserver.bean.RXInventoryTag;
import com.ridko.third.rodinbell.rfid.rxobserver.bean.RXOperationTag;
import com.ridko.third.rodinbell.util.StringTool;
...
public class RXObserver implements Observer{
    ...
    /**
     * The method will callback when execute the commands about tag mask include {@link com.rfid.RFIDReaderHelper#setTagMask(byte, byte, byte, byte, byte, byte, byte, byte[])}}
     * {@link com.rfid.RFIDReaderHelper#getTagMask(byte)},{@link com.rfid.RFIDReaderHelper#clearTagMask(byte, byte)}
     *
     */
